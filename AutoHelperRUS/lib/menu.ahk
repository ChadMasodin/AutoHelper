...
; Melee menu
Menu, Submenu1, Add, скорость атаки - к шансу на крит, menuHandler
...
Menu, Submenu2, Add, против скав - против бронированных, menuHandler
Menu, Submenu2, Add, против скав - против берсерков, menuHandler
Menu, Submenu2, Add, против скав - против пехоты, menuHandler
Menu, Submenu2, Add, против скав - против монстров, menuHandler

; Necklace menu
Menu, Submenu3, Add, Затраты на блок - к здоровью, menuHandler
Menu, Submenu3, Add, Затраты на блок - к углу отталкивания, menuHandler
Menu, Submenu3, Add, к выносливости - Затраты на блок, menuHandler
Menu, Submenu3, Add, к выносливости - к здоровью, menuHandler
Menu, Submenu3, Add, к выносливости - к углу отталкивания, menuHandler
...
Menu, Submenu4, Add, против скав - против берсерков, menuHandler
Menu, Submenu4, Add, против скав - против пехоты, menuHandler
Menu, Submenu4, Add, против скав - против монстров, menuHandler

; Trinket menu
Menu, Submenu5, Add, к скорости восстановления - к шансу на крит, menuHandler
Menu, Submenu5, Add, к скорости восстановления - к сопротивлению проклятью, menuHandler
Menu, Submenu5, Add, к скорости восстановления - к скорости передвижения, menuHandler
Menu, Submenu5, Add, к скорости восстановления - к скорости оживления, menuHandler
Menu, Submenu5, Add, к скорости восстановления - к скорости восстановления запаса сил, menuHandler
Menu, Submenu5, Add, к шансу на крит - к сопротивлению проклятью, menuHandler
Menu, Submenu5, Add, к шансу на крит - к скорости передвижения, menuHandler
Menu, Submenu5, Add, к шансу на крит - к скорости оживления, menuHandler
Menu, Submenu5, Add, к шансу на крит - к скорости восстановления запаса сил, menuHandler
Menu, Submenu5, Add, к сопротивлению проклятью - к скорости передвижения, menuHandler
Menu, Submenu5, Add, к сопротивлению проклятью - к скорости восстановления запаса сил, menuHandler
Menu, Submenu5, Add, к скорости передвижения - к скорости оживления, menuHandler
Menu, Submenu5, Add, к скорости передвижения - к скорости восстановления запаса сил, menuHandler
Menu, Submenu5, Add, к скорости оживления - к скорости восстановления запаса сил, menuHandler

Menu, RerollScript, Add, Ближнее, :Submenu1
Menu, RerollScript, Add, Дальнее, :Submenu2
Menu, RerollScript, Add ; Add a separator line
Menu, RerollScript, Add, Ожерелье, :Submenu3
Menu, RerollScript, Add, Оберег, :Submenu4
Menu, RerollScript, Add, Украшение, :Submenu5
return