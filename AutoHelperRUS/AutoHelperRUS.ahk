...
CreateGUI:
    ...
    Gui, Add, GroupBox, x10 y40 w380 h330 Center Section, Настройка скриптов
    Gui, Font
   ...
   ; Gui, Add, Button, xs+15 yp+25 w140 h25 gSetGreenDustArea, Выделить область
    ...
    Gui, Add, Text, xs+15 yp+30, #4 Позиция предмета в слоте переброса (FOR OLD UI):
    Gui, Font, s9
    ...
    ; Additional Settings
    Gui, Font, s10, Segoe UI
    Gui, Add, Text, x25 y600, Общий ограничитель циклов (опционально):
    Gui, Add, Edit, x+10 w75 h20 vLoopCount Number

    Gui, Font, s9 Bold, Segoe UI
    Gui, Add, Button, x25 y630 w130 h30 gSetLocation, Установите окно:
    Gui, Add, Edit, x+15 yp+3 w210 h25 vTarget_Window ReadOnly, %Target_Window%
    Gui, Font

    ; Action Buttons Section
    Gui, Font, c535353 s13 Bold Q3, Segoe UI Black
    Gui, Add, GroupBox, x10 y380 w380 h210 Center Section, Кнопки
    Gui, Font, s9 Bold, Segoe UI
...
ShowInfo:
    ...
    Gui, Add, Text, xs+145 yp+15, Дата обновы:  16/11/25
