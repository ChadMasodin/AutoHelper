...
CreateGUI:
    ...
    Gui, Add, GroupBox, x10 y40 w380 h390 Center Section, Script Settings
    Gui, Font
    ...
    ; AfterReroll
    Gui, Font, s11, Segoe UI
    Gui, Add, Text, xs+15 yp+30, #5 Item slot position after reroll:
    Gui, Font, s9
    ...
    ; Additional Settings
    Gui, Font, s11, Segoe UI
    Gui, Add, Text, x65 y650, General Loop Limiter (optional):
    Gui, Add, Edit, x+10 w75 h20 vLoopCount Number

    Gui, Font, s9 Bold, Segoe UI
    Gui, Add, Button, x25 y680 w130 h30 gSetLocation, Set Target Window:
    Gui, Add, Edit, x+15 yp+3 w210 h25 vTarget_Window ReadOnly, %Target_Window%
    Gui, Font

    ; Action Buttons Section
    Gui, Font, c535353 s13 Bold Q3, Segoe UI Black
    Gui, Add, GroupBox, x10 y430 w380 h210 Center Section, Buttons
    Gui, Font, s9 Bold, Segoe UI
...
RerollProperties:
    ...
    if ((!X6 || !Y6)) {
        MsgBox, 16, Error, Property change/salvage button location not set!`nSet coordinates before running.
        return
    }
