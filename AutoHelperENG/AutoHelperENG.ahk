...
CreateGUI:
    ...
    Gui, Add, GroupBox, x10 y40 w380 h330 Center Section, Script Settings
    Gui, Font
    ...
    Gui, Font, s9
    Gui,Add,Button,xs+15 yp+25 w140 h25 gSet_Pos_Button, Salvage Button
   ...
   ; Gui, Add, Text, xs+15 yp+30, #4 Green dust icon area:
    ...
    ; AfterReroll
    Gui, Font, s11, Segoe UI
    Gui, Add, Text, xs+15 yp+30, #4 Item slot position after reroll (FOR OLD UI):
    Gui, Font, s9
    Gui, Add, Button, xs+15 yp+25 w80 h25 gSet_Pos_AfterReroll, Set
    Gui, Add, Edit, x+15 yp+3 w80 h20 vPos_7 ReadOnly,

    ; Additional Settings
    Gui, Font, s11, Segoe UI
    Gui, Add, Text, x65 y600, General Loop Limiter (optional):
    Gui, Add, Edit, x+10 w75 h20 vLoopCount Number

    Gui, Font, s9 Bold, Segoe UI
    Gui, Add, Button, x25 y630 w130 h30 gSetLocation, Set Target Window:
    Gui, Add, Edit, x+15 yp+3 w210 h25 vTarget_Window ReadOnly, %Target_Window%
    Gui, Font

    ; Action Buttons Section
    Gui, Font, c535353 s13 Bold Q3, Segoe UI Black
    Gui, Add, GroupBox, x10 y380 w380 h210 Center Section, Buttons
    Gui, Font, s9 Bold, Segoe UI
...
ShowInfo:
    ...
    Gui, Add, Text, xs+145 yp+15, Update date:  16/11/25
...
RerollProperties:
    ...
    if ((!X6 || !Y6)) {
        MsgBox, 16, Error, Re-roll/Salvage button position not set!`nSet coordinates before running.
        return
    }

    ;if (!X7 || !Y7) {
        ;MsgBox, 16, Error, Item slot position not set!`nSet coordinates before running.
       ; return
    ;}
